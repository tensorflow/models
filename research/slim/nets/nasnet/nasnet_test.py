...
class NASNetTest(tf.test.TestCase):
  ...
  def testAllEndPointsShapesCifarModel(self):
    ...
    endpoints_shapes = {'Stem': [batch_size, 32, 32, 96],
                        # 'Cell_0': [batch_size, 192, 32, 32],
                        # 'Cell_1': [batch_size, 192, 32, 32],
                        # 'Cell_2': [batch_size, 192, 32, 32],
                        # 'Cell_3': [batch_size, 192, 32, 32],
                        # 'Cell_4': [batch_size, 192, 32, 32],
                        # 'Cell_5': [batch_size, 192, 32, 32],
                        # 'Cell_6': [batch_size, 384, 16, 16],
                        # 'Cell_7': [batch_size, 384, 16, 16],
                        # 'Cell_8': [batch_size, 384, 16, 16],
                        # 'Cell_9': [batch_size, 384, 16, 16],
                        # 'Cell_10': [batch_size, 384, 16, 16],
                        # 'Cell_11': [batch_size, 384, 16, 16],
                        # 'Cell_12': [batch_size, 768, 8, 8],
                        # 'Cell_13': [batch_size, 768, 8, 8],
                        # 'Cell_14': [batch_size, 768, 8, 8],
                        # 'Cell_15': [batch_size, 768, 8, 8],
                        # 'Cell_16': [batch_size, 768, 8, 8],
                        # 'Cell_17': [batch_size, 768, 8, 8],
                        # 'Reduction_Cell_0': [batch_size, 256, 16, 16],
                        # 'Reduction_Cell_1': [batch_size, 512, 8, 8],
  ...
  def testAllEndPointsShapesMobileModel(self):
    ...
    print(end_points)
    # endpoints_shapes = {'Stem': [batch_size, 88, 28, 28],
    #                     'Cell_0': [batch_size, 264, 28, 28],
    #                     'Cell_1': [batch_size, 264, 28, 28],
    #                     'Cell_2': [batch_size, 264, 28, 28],
    #                     'Cell_3': [batch_size, 264, 28, 28],
    #                     'Cell_4': [batch_size, 528, 14, 14],
    #                     'Cell_5': [batch_size, 528, 14, 14],
    #                     'Cell_6': [batch_size, 528, 14, 14],
    #                     'Cell_7': [batch_size, 528, 14, 14],
    #                     'Cell_8': [batch_size, 1056, 7, 7],
    #                     'Cell_9': [batch_size, 1056, 7, 7],
    #                     'Cell_10': [batch_size, 1056, 7, 7],
    #                     'Cell_11': [batch_size, 1056, 7, 7],
    #                     'Reduction_Cell_0': [batch_size, 352, 14, 14],
    #                     'Reduction_Cell_1': [batch_size, 704, 7, 7],
  ...
  def testAllEndPointsShapesLargeModel(self):
    ...
    print(end_points)
    # endpoints_shapes = {'Stem': [batch_size, 336, 42, 42],
    #                     'Cell_0': [batch_size, 1008, 42, 42],
    #                     'Cell_1': [batch_size, 1008, 42, 42],
    #                     'Cell_2': [batch_size, 1008, 42, 42],
    #                     'Cell_3': [batch_size, 1008, 42, 42],
    #                     'Cell_4': [batch_size, 1008, 42, 42],
    #                     'Cell_5': [batch_size, 1008, 42, 42],
    #                     'Cell_6': [batch_size, 2016, 21, 21],
    #                     'Cell_7': [batch_size, 2016, 21, 21],
    #                     'Cell_8': [batch_size, 2016, 21, 21],
    #                     'Cell_9': [batch_size, 2016, 21, 21],
    #                     'Cell_10': [batch_size, 2016, 21, 21],
    #                     'Cell_11': [batch_size, 2016, 21, 21],
    #                     'Cell_12': [batch_size, 4032, 11, 11],
    #                     'Cell_13': [batch_size, 4032, 11, 11],
    #                     'Cell_14': [batch_size, 4032, 11, 11],
    #                     'Cell_15': [batch_size, 4032, 11, 11],
    #                     'Cell_16': [batch_size, 4032, 11, 11],
    #                     'Cell_17': [batch_size, 4032, 11, 11],
    #                     'Reduction_Cell_0': [batch_size, 1344, 21, 21],
    #                     'Reduction_Cell_1': [batch_size, 2688, 11, 11],
