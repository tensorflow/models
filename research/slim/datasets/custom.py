...
tensorflow/models/research/slim/datasets/download_and_convert_data.py, which can be invoked in the /scripts folder using step1_prepare_dataset.sh script command
"""
...
SPLITS_TO_SIZES = {"train": 1500, "validation": 233}
