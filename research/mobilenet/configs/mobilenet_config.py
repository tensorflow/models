...
@dataclass
class MobileNetV1BlockConfig(base_config.Config):
...
class MobileNetV1Config(base_config.Config):
  ...
  blocks: Tuple[MobileNetV1BlockConfig, ...] = (
    # (kernel, stride, depth)
    # pylint: disable=bad-whitespace
    # base normal conv
    MobileNetV1BlockConfig.from_args((3, 3), 2, 32, Conv),
    # depthsep conv
    MobileNetV1BlockConfig.from_args((3, 3), 1, 64, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 2, 128, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 128, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 2, 256, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 256, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 2, 512, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 512, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 512, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 512, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 512, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 512, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 2, 1024, DepSepConv),
    MobileNetV1BlockConfig.from_args((3, 3), 1, 1024, DepSepConv),
