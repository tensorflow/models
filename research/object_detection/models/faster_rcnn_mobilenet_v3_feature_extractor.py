...
class FasterRCNNMobilenetV3FeatureExtractor(
    faster_rcnn_meta_arch.FasterRCNNFeatureExtractor):
  """Faster R-CNN Mobilenet V3 feature extractor implementation."""
  ...
  def __init__(self,
    ...
    super(FasterRCNNMobilenetV3FeatureExtractor, self).__init__(
  ...
  def _extract_box_classifier_features(self, proposal_feature_maps, scope):
    ...
    with tf.variable_scope('MobilenetV3', reuse=self._reuse_weights):
      with slim.arg_scope(
          mobilenet_v3.training_scope(is_training=None, weight_decay=self._weight_decay)):
        with slim.arg_scope(
