...
def visualize_boxes_and_labels_on_image_array(
    ...
    for i in range(min(max_boxes_to_draw, boxes.shape[0])):
        if scores is None or scores[i] > min_score_thresh:
            ...
            if scores is None:
                ...
                print("FEWIMAGEZA : " + str(class_name))
                
                my_list.extend(str(class_name)) 
    ...
    print("FEWHAKKO : " + str(class_name))
    
    if new_xml != False:
      print(file_name)
      xml = generate_xml.GenerateXml(array_position, im_width, im_height, my_list, str(file_name))
