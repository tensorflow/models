...
extracted from audio input. The network uses Connectionist Temporal Classification (CTC) as the loss function.
...
tf.data.Dataset object to feed data. Within each training cycle (except for the
