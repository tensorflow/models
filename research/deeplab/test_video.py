    ...
    def run_video(self, video_path):
        ...
        while True:
            ...
            if ret:
                ...
                seg_image = get_dataset_colormapTJ.label_to_color_image(seg_map, get_dataset_colormapTJ.get_rugd_name()).astype(np.uint8)
...
FULL_COLOR_MAP = get_dataset_colormapTJ.label_to_color_image(FULL_LABEL_MAP)
...
def run_demo_image(image_name,i):
    ...
    #saving as image
    seg_map = get_dataset_colormapTJ.label_to_color_image(seg_map, get_dataset_colormapTJ.get_rugd_name()).astype(np.uint8)
    txt = "{}".format(i).zfill(4)+'.bmp'
    print(txt)
...
for i in range(1,7326):
    txt = "{}".format(i).zfill(4)
    print(txt+'.png')
