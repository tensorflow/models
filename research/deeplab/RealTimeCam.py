...
# https://github.com/priya-dwivedi/Deep-Learning/tree/master/deeplab
# https://averdones.github.io/real-time-semantic-image-segmentation-with-deeplab-in-tensorflow/?fbclid=IwAR0KRiCngAUk9e2uoDZoRBZPHtrCb900roo73d-B-v9wKSH-bLtABfyUUzU
# Imports
import collections
import os
import io
...
class DeepLabModel(object):
    ...
    def run(self, image):
        ...
        resize_ratio = 1.1# * self.INPUT_SIZE / max(width, height)
...
def run_demo_image(image_name):
    ...
    #saving as image
    #seg_map = get_dataset_colormap.label_to_color_image(seg_map, get_dataset_colormap.get_rugd_name()).astype(np.uint8)
    #plt2.imsave(os.path.dirname(__file__)+'\\datasets\\rugd\\ObrazkyExport\Obrazok_8bit.png', seg_map)

#run_demo_image('creek_00001.png')
#run_demo_image('Lapaj.jpg')
#run_demo_image('Clipboard07.jpg')
#run_demo_image('IMG20230401143409.jpg')
run_demo_image('001c_8bit.jpg')
