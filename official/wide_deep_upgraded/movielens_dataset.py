...
_FEATURE_MAP = {
    movielens.USER_COLUMN: tf.io.FixedLenFeature([1], dtype=tf.int64),
    movielens.ITEM_COLUMN: tf.io.FixedLenFeature([1], dtype=tf.int64),
    movielens.TIMESTAMP_COLUMN: tf.io.FixedLenFeature([1], dtype=tf.int64),
    movielens.GENRE_COLUMN: tf.io.FixedLenFeature(
        [movielens.N_GENRE], dtype=tf.int64),
    movielens.RATING_COLUMN: tf.io.FixedLenFeature([1], dtype=tf.float32),
}
...
def _deserialize(examples_serialized):
  features = tf.io.parse_example(serialized=examples_serialized, features=_FEATURE_MAP)
