...
def create_model(params, is_train):
  ...
  with tf.name_scope("model"):
    if is_train:
      ...
      internal_model = Roformer(params, name="transformer_v2")
...
class Roformer(tf.keras.Model):
  ...
  def __init__(self, params, name=None):
    ...
    """
    super(Roformer, self).__init__(name=name)
    self.params = params
  ...
  def encode(self, inputs, attention_bias, training):
    ...
    with tf.name_scope("encode"):
      ...
      with tf.name_scope("not_add_pos_encoding"):
...
class EncoderStack(tf.keras.layers.Layer):
  ...
  def build(self, input_shape):
    ...
    for _ in range(params["num_hidden_layers"]):
      ...
      self_attention_layer = rotary_position_embedding.Roformer_SelfAttention(
  ...
  def build(self, input_shape):
    ...
    for _ in range(params["num_hidden_layers"]):
      self_attention_layer = rotary_position_embedding.Roformer_SelfAttention(
          params["hidden_size"], params["num_heads"],
          params["attention_dropout"])
      enc_dec_attention_layer = rotary_position_embedding.Roformer_Attention(
          params["hidden_size"], params["num_heads"],
          params["attention_dropout"])
      feed_forward_network = ffn_layer.FeedForwardNetwork(
          params["hidden_size"], params["filter_size"], params["relu_dropout"])
