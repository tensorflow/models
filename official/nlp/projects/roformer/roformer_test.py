...
from official.nlp.projects.roformer import roformer
...
class TransformerV2Test(tf.test.TestCase):
  ...
  def test_create_model_train(self):
    model = roformer.create_model(self.params, True)
  ...
  def test_create_model_not_train(self):
    model = roformer.create_model(self.params, False)
    inputs, outputs = model.inputs, model.outputs
  ...
  def test_export(self):
    model = roformer.Roformer(self.params, name="Roformer_v2")
