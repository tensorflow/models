...
class BertTokenizer(keras.layers.Layer):
...
class SentencepieceTokenizer(keras.layers.Layer):
...
class BertPackInputs(keras.layers.Layer):
...
class FastWordpieceBertTokenizer(keras.layers.Layer):
