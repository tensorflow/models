...
class ClassificationTest(keras_parameterized.TestCase):
    ...
    def test_network_creation(self):
        ...
        input_width = 512
        num_classes = 10
        test_object = classification.Classification(input_width=input_width,
    ...
    def test_network_invocation_with_logit_output(self):
        ...
        test_object = classification.Classification(input_width=input_width,
                                                    num_classes=num_classes,
                                                    output='predictions')
        logit_object = classification.Classification(input_width=input_width,
                                                     num_classes=num_classes,
                                                     output='logits')
    ...
    def test_serialize_deserialize(self):
        ...
        network = classification.Classification(input_width=128,
                                                num_classes=10,
                                                initializer='zeros',
                                                output='predictions')
    ...
    def test_unknown_output_type_fails(self):
        with self.assertRaisesRegex(ValueError,
            ...
            _ = classification.Classification(input_width=128,
                                              num_classes=10,
                                              output='bad')
