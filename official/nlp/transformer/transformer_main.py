...
class TransformerTask(object):
    ...
    """
        ...
        params[
            "batch_size"] = flags_obj.batch_size or params["default_batch_size"]
    ...
    def train(self):
      ...
      """
            ...
            def _step_fn(inputs):
                ...
                tvars = list({id(v): v for v in model.trainable_variables
                             }.values())
                ...
                with summary_writer.as_default():
                    ...
                    if params["enable_tensorboard"]:
                        for metric_obj in train_metrics:
                            tf.compat.v2.summary.scalar(metric_obj.name,
                                                        metric_obj.result(),
                                                        current_step)
    ...
    def eval(self):
        ...
        with distribution_utils.get_strategy_scope(distribution_strategy):
            if not self.predict_model:
                self.predict_model = transformer.create_model(
                    self.params, False)
    ...
    def _create_optimizer(self):
        ...
        opt = performance.configure_optimizer(
            ...
            use_graph_rewrite=self.flags_obj.fp16_implementation ==
            "graph_rewrite",
            loss_scale=flags_core.get_loss_scale(self.flags_obj,
