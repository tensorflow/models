...
from official.nlp.data import electra_create_pretraining_data
...
def create_pretrain_dataset(input_patterns,
  ...
  def _select_data_from_record(record):
    ...
    token, mlm_pos, mlm_l = electra_create_pretraining_data.create_masked_lm_predictions(record['input_word_ids'],
                                                        mlm_prob, max_predictions_per_seq, vocab,random.Random(FLAGS.random_seed),do_whole_word_mask)
    x['input_word_ids'] = token
    masked_lm_positions = list(mlm_pos)
    masked_lm_ids = tokenizer.convert_tokens_to_ids(mlm_l)
