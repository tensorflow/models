...
flags.DEFINE_bool("create_train_data",
                  default=True,
                  help="Whether to create training data.")
flags.DEFINE_bool("create_eval_data",
                  default=False,
                  help="Whether to create eval data.")
...
def preprocess():
    ...
    if FLAGS.create_train_data:
        ...
        train_examples = squad_utils.read_squad_examples(FLAGS.train_file,
                                                         is_training=True)
        ...
        train_writer = squad_utils.FeatureWriter(filename=train_rec_file,
                                                 is_training=True)
    ...
    if FLAGS.create_eval_data:
        ...
        squad_utils.create_eval_data(spm_basename, sp_model, eval_examples,
                                     ...
                                     FLAGS.max_query_length, FLAGS.doc_stride,
                                     FLAGS.uncased, FLAGS.output_dir)
