...
flags.DEFINE_float("lr_layer_decay_rate",
                   default=1.0,
...
flags.DEFINE_string("ff_activation",
                    default="relu",
...
flags.DEFINE_integer("test_data_size",
                     default=12048,
...
flags.DEFINE_integer("test_batch_size",
                     default=16,
                     help="Size of the test batch across all hosts.")
flags.DEFINE_integer("save_steps",
                     default=1000,
                     help="Number of steps for saving checkpoint.")
FLAGS = flags.FLAGS
