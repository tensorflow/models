...
class ExportAlbertTfhubTest(tf.test.TestCase):
    ...
    def test_export_albert_tfhub(self):
        ...
        albert_config = configs.AlbertConfig(vocab_size=100,
                                             embedding_size=8,
                                             hidden_size=16,
                                             ...
                                             num_hidden_layers=1)
        bert_model, encoder = export_albert_tfhub.create_albert_model(
            albert_config)
        ...
        export_albert_tfhub.export_albert_tfhub(albert_config,
        ...
        if hasattr(hub_layer, "resolved_object"):
            with tf.io.gfile.GFile(hub_layer.resolved_object.sp_model_file.
