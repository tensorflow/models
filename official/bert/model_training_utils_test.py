"""Tests for official.bert.model_training_utils."""
...
def create_model_fn(input_shape, num_classes):
...
class ModelTrainingUtilsTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_train_check_artifacts(self, distribution):
    ...
    # Two checkpoints should be saved after two epochs. 6 files in total.
