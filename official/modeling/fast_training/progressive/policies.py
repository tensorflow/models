...
class ProgressivePolicy:
  ...
  def get_model(self,
                stage_id: int,
                old_model: keras.Model = None) -> keras.Model:  # pytype: disable=annotation-type-mismatch  # typed-keras
  ...
  @property
  def cur_model(self) -> keras.Model:
  ...
  @property
  def cur_optimizer(self) -> keras.optimizers.Optimizer:
