...
def train(
    ...
    learning_rate_fn: keras.optimizers.schedules.LearningRateSchedule,
    eval_fn: Optional[Callable[[keras.Model, int, tf.summary.SummaryWriter],
                               Any]] = None,
    metric_fn: Optional[Callable[[], keras.metrics.Metric]] = None,
