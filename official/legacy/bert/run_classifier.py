...
def run_bert_classifier(strategy,
  ...
  # keras.losses objects accept optional sample_weight arguments (eg. coming
  ...
  loss_fn = (keras.losses.MeanSquaredError() if is_regression
...
def custom_main(custom_callbacks=None, custom_metrics=None):
  ...
  Args:
    custom_callbacks: list of keras.Callbacks passed to training loop.
