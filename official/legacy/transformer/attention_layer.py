...
class Attention(keras.layers.Layer):
  ...
  def build(self, input_shape):
    ...
    attention_initializer = _glorot_initializer(input_shape.as_list()[-1],
                                                self.hidden_size)
    self.query_dense_layer = keras.layers.EinsumDense(
        "BTE,ENH->BTNH",
        output_shape=(None, self.num_heads, size_per_head),
        kernel_initializer=tf_utils.clone_initializer(attention_initializer),
        bias_axes=None,
        name="query")
    self.key_dense_layer = keras.layers.EinsumDense(
        "BTE,ENH->BTNH",
        output_shape=(None, self.num_heads, size_per_head),
        kernel_initializer=tf_utils.clone_initializer(attention_initializer),
        bias_axes=None,
        name="key")
    self.value_dense_layer = keras.layers.EinsumDense(
        "BTE,ENH->BTNH",
        output_shape=(None, self.num_heads, size_per_head),
        kernel_initializer=tf_utils.clone_initializer(attention_initializer),
        bias_axes=None,
    ...
    self.output_dense_layer = keras.layers.EinsumDense(
        "BTNH,NHE->BTE",
