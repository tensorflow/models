...
class CtlBenchmark(PerfZeroBenchmark):
    ...
    def __init__(self, output_dir=None, default_flags=None, flag_methods=None):
        ...
        super(CtlBenchmark, self).__init__(output_dir=self.output_dir,
...
class Resnet50CtlAccuracy(CtlBenchmark):
    ...
    """
        ...
        super(Resnet50CtlAccuracy, self).__init__(output_dir=output_dir,
...
class Resnet50CtlBenchmarkSynth(Resnet50CtlBenchmarkBase):
    ...
    def __init__(self, output_dir=None, root_data_dir=None, **kwargs):
        ...
        super(Resnet50CtlBenchmarkSynth, self).__init__(output_dir=output_dir,
...
class Resnet50CtlBenchmarkReal(Resnet50CtlBenchmarkBase):
    ...
    def __init__(self, output_dir=None, root_data_dir=None, **kwargs):
        ...
        super(Resnet50CtlBenchmarkReal, self).__init__(output_dir=output_dir,
                                                       default_flags=def_flags)
