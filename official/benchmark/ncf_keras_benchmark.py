...
class NCFKerasAccuracy(NCFKerasBenchmarkBase):
    ...
    def __init__(self,
        ...
        default_flags['data_dir'] = os.path.join(root_data_dir,
                                                 NCF_DATA_DIR_NAME)

        super(NCFKerasAccuracy, self).__init__(output_dir=output_dir,
    ...
    """
        super(NCFKerasAccuracy,
              self)._run_and_report_benchmark(hr_at_10_min=hr_at_10_min,
...
class NCFKerasSynth(NCFKerasBenchmarkBase):
    ...
    def __init__(self, output_dir=None, default_flags=None, **kwargs):
        ...
        super(NCFKerasSynth, self).__init__(output_dir=output_dir,
                                            default_flags=default_flags,
                                            **kwargs)
