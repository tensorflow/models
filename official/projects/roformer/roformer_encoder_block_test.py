...
@parameterized.named_parameters(
    ('base', RoformerEncoderBlock))
class RoformerEncoderBlockLayerTest(keras_parameterized.TestCase):

  def tearDown(self):
    super(RoformerEncoderBlockLayerTest, self).tearDown()
...
class RoformerArgumentTest(keras_parameterized.TestCase):
  ...
  def test_get_config(self):
    ...
    new_encoder_block = RoformerEncoderBlock.from_config(
  ...
  def test_several_attention_axes(self, attention_axes):
    test_layer = RoformerEncoderBlock(
        inner_dim=32,
        inner_activation='relu',
        output_dropout=0.1,
        attention_dropout=0.1,
