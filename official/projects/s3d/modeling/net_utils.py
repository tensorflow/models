...
WEIGHT_INITIALIZER = {
    ...
    'Gaussian': lambda: keras.initializers.RandomNormal(stddev=0.01),
}
...
class ParameterizedConvLayer(keras.layers.Layer):
  ...
  def _append_conv_layer(self, param):
    ...
    self._parameterized_conv_layers.append(
        keras.layers.Activation('relu', **relu_layer_params))
