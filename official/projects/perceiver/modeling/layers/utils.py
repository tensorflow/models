...
def _build_transformer_encoder_block_args(
  ...
  Args:
    ...
    att_init_scale:
      Scale for the `keras.initializers.VarianceScaling` used in attention
      kernel.
    dense_init_scale:
      Scale for the `keras.initializers.VarianceScaling` used in MLP kernel.
    use_query_residual:
      Toggle to execute residual connection after attention.
    norm_epsilon:
  ...
  return {
      ...
      "inner_activation":
          functools.partial(keras.activations.gelu, approximate=True),
      "kernel_initializer":
          keras.initializers.VarianceScaling(scale=dense_init_scale),
      "attention_initializer":
          keras.initializers.VarianceScaling(scale=att_init_scale),
      "norm_first":
          True,
      "norm_epsilon":
          norm_epsilon,
