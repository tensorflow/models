...
class SpatiotemporalActionLocalizationTask(
  ...
  def build_model(self) -> keras.Model:
    ...
    input_specs_dict = {
        ...
        'instances_position':
            keras.layers.InputSpec(shape=[None, num_instances, 4]),
    }
  ...
  def build_losses(self,
    ...
    # in shape [B, N]
    xent_loss_fn = keras.losses.BinaryCrossentropy(
  ...
  def build_metrics(self, training: bool = True):
    ...
    metrics = [
        keras.metrics.AUC(curve='PR', multi_label=True, name='AUPR'),
        keras.metrics.AUC(curve='ROC', multi_label=True, name='AUROC'),
    ]
