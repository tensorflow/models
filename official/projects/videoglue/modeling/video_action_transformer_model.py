...
class VideoActionTransformerModel(keras.Model):
  ...
  def __init__(
    ...
    if not input_specs:
      input_specs = {
          'image':
              keras.layers.InputSpec(shape=[None, None, None, None, 3]),
          'instances_position':
              keras.layers.InputSpec(shape=[None, None, 4]),
      }
...
def build_video_action_transformer_model(
    input_specs_dict: Mapping[str, keras.layers.InputSpec],
