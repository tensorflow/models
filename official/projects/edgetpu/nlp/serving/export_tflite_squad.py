...
def build_model_for_serving(model: keras.Model,
                            sequence_length: int = 384,
                            batch_size: int = 1) -> keras.Model:
  ...
  """
  word_ids = keras.Input(shape=(sequence_length,),
                            batch_size=batch_size,
                            dtype=tf.int32,
                            name='input_word_ids')
  mask = keras.Input(shape=(sequence_length,),
                        batch_size=batch_size,
                        dtype=tf.int32, name='input_mask')
  type_ids = keras.Input(shape=(sequence_length,),
                            batch_size=batch_size,
