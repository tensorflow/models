...
def load_searched_model(saved_model_path: str) -> keras.Model:
  ...
  with tempfile.TemporaryDirectory() as tmp_dir:
    ...
    model = keras.models.load_model(load_path, options=load_options)
...
class EdgeTPUTask(base_task.Task):
  ...
  def build_metrics(self,
                    training: bool = True) -> List[keras.metrics.Metric]:
  ...
  def inference_step(self, inputs: tf.Tensor, model: keras.Model):
