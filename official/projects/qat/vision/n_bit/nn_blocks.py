...
class BottleneckBlockNBitQuantized(keras.layers.Layer):
...
# QAT.
@keras.utils.register_keras_serializable(package='Vision')
class Conv2DBNBlockNBitQuantized(keras.layers.Layer):
...
@keras.utils.register_keras_serializable(package='Vision')
class InvertedBottleneckBlockNBitQuantized(keras.layers.Layer):
