...
class SegmentationModelQuantized(keras.Model):
  ...
  def __init__(self, backbone: keras.Model, decoder: keras.layers.Layer,
               head: keras.layers.Layer,
               input_specs: keras.layers.InputSpec, **kwargs):
