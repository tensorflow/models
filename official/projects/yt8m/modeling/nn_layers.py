...
class ContextGate(keras.layers.Layer):
  ...
  def __init__(
      ...
      kernel_initializer: Union[
          str, keras.regularizers.Regularizer
      ] = "glorot_uniform",
      kernel_regularizer: Optional[keras.regularizers.Regularizer] = None,
      bias_initializer: Union[str, keras.regularizers.Regularizer] = "zeros",
    ...
    if hidden_layer_size >= 2:
      self._gates_bottleneck = keras.layers.Dense(
          hidden_layer_size,
          activation="relu6",
  ...
  def build(self, input_shape):
    ...
    self._gates = keras.layers.Dense(
        feature_size,
