...
class LinformerEncoder(tf.keras.layers.Layer):
  ...
  def __init__(
    ...
    self._embedding_dropout = tf.keras.layers.Dropout(rate=output_dropout,
    ...
    self._pooler_layer = tf.keras.layers.Dense(units=hidden_size,
                                               activation='tanh',
                                               kernel_initializer=initializer,
  ...
  def call(self, inputs):
    ...
    output = dict(sequence_output=encoder_outputs[-1],
