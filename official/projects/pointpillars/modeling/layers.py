...
class ConvBlock(keras.layers.Layer):
  ...
  def __init__(
      ...
      kernel_initializer: Optional[keras.initializers.Initializer] = tf.keras
      .initializers.VarianceScaling(),
      kernel_regularizer: Optional[keras.regularizers.Regularizer] = None,
      use_bias: bool = False,
      bias_initializer: Optional[keras.initializers.Initializer] = tf.keras
      .initializers.Zeros(),
  ...
  def build(self, input_shape: tf.TensorShape):
    ...
    if self._use_transpose_conv:
      conv_op = keras.layers.Conv2DTranspose
    else:
