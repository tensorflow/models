...
class TransformerEncoder(keras.layers.Layer):
  ...
  def __init__(self,
    ...
    Args:
      ...
      **kwargs: key word arguemnts passed to keras.layers.Layer.
    """
...
class TransformerDecoderBlock(keras.layers.Layer):
  ...
  def build(self, input_shape):
    ...
    self.self_attention = layers.attention.CachedAttention(
        ...
        name="self_attention",
        **common_kwargs)
    self.self_attention_output_dense = keras.layers.EinsumDense(
        "abc,cd->abd",
        output_shape=(None, hidden_size),
        bias_axes="d",
        kernel_initializer=tf_utils.clone_initializer(self._kernel_initializer),
    ...
    self.encdec_attention_dropout = keras.layers.Dropout(
        rate=self.dropout_rate)
    ...
    self.intermediate_dense = keras.layers.EinsumDense(
        "abc,cd->abd",
        ...
        name="intermediate",
        **common_kwargs)
    self.intermediate_activation_layer = keras.layers.Activation(
        self.intermediate_activation)
    self._intermediate_dropout_layer = keras.layers.Dropout(
    ...
    self.output_dense = keras.layers.EinsumDense(
        ...
        name="output",
        **common_kwargs)
    self.output_dropout = keras.layers.Dropout(rate=self.dropout_rate)
