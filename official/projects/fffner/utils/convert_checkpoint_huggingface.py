...
def _create_fffner_model(huggingface_bert_config):
  ...
  encoder = FFFNerEncoder(
      ...
      inner_activation=tf_utils.get_activation(huggingface_bert_config.hidden_act),
  ...
  for layer_num in range(num_layers):
    encoder._transformer_layers[
      ...
      bert_model[
          ...
          .reshape(
          (hidden_size, num_attention_heads, head_size)), bert_model[
...
def convert_checkpoint(huggingface_model_name_or_path, output_path):
  ...
  huggingface_bert_model, huggingface_bert_config = _get_huggingface_bert_model_and_config(huggingface_model_name_or_path)
