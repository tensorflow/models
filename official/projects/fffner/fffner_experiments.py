      ...
      task=fffner_prediction.FFFNerPredictionConfig(
          model=fffner_prediction.FFFNerModelConfig(
              encoder=encoders.EncoderConfig(
                  type='any', any=FFFNerEncoderConfig())),
          train_data=fffner_dataloader
          .FFFNerDataConfig(),
          validation_data=fffner_dataloader
          .FFFNerDataConfig(
              is_training=False, drop_remainder=False, include_example_id=True)),
