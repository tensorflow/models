...
class FFFNerEncoder(tf.keras.layers.Layer):
  ...
  def call(self, inputs):
    ...
    encoder_output_is_entity = tf.gather(last_encoder_output, indices=is_entity_token_pos, axis=1, batch_dims=1)
    encoder_output_entity_type = tf.gather(last_encoder_output, indices=entity_type_token_pos, axis=1, batch_dims=1)
    cls_output_is_entity = self._pooler_layer_is_entity(encoder_output_is_entity)
    cls_output_entity_type = self._pooler_layer_entity_type(encoder_output_entity_type)
