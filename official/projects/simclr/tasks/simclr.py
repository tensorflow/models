  ...
  def build_losses(self,
    ...
    if self.task_config.model.supervised_head is not None:
      ...
      if self.task_config.evaluation.one_hot:
        sup_loss = keras.losses.CategoricalCrossentropy(
            from_logits=True, reduction=keras.losses.Reduction.NONE)(labels,
                                                                        outputs)
      else:
        sup_loss = keras.losses.SparseCategoricalCrossentropy(
            from_logits=True, reduction=keras.losses.Reduction.NONE)(labels,
                                                                        outputs)
