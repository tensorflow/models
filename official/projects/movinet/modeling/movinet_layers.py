...
class MobileConv2D(keras.layers.Layer):
  ...
  def __init__(
    ...
    For the majority of arguments, see keras.layers.Conv2D.
...
class StreamConvBlock(ConvBlock):
  ...
  def __init__(
      ...
      use_bias: bool = False,
      kernel_initializer: keras.initializers.Initializer = 'HeNormal',
      kernel_regularizer: Optional[keras.regularizers.Regularizer] = tf.keras
...
class ClassifierHead(keras.layers.Layer):
  ...
  def __init__(
      ...
      kernel_initializer: keras.initializers.Initializer = 'HeNormal',
      kernel_regularizer: Optional[keras.regularizers.Regularizer] =
      keras.regularizers.L2(KERNEL_WEIGHT_DECAY),  # pytype: disable=annotation-type-mismatch  # typed-keras
      **kwargs):
