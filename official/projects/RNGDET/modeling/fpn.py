...
class FPN(tf.keras.Model):
  ...
  def __init__(
    ...
    #for level in range(min_level, backbone_max_level + 1):
    for level in range(min_level, backbone_max_level):
    ...
    feats_5 = conv2d(
          ...
          name=f'semantic_5_0')(
              feats['5'])
    feats_5 = activation_fn(tf.keras.layers.GroupNormalization(256)(feats_5))
    feats_5 = spatial_transform_ops.nearest_upsampling(
          feats_5, 8, use_keras_layer=use_keras_layer)
    ...
    feats_5 = conv2d(
          ...
          name=f'semantic_5_2')(
              feats_5)
    feats_5 = activation_fn(tf.keras.layers.GroupNormalization(128)(feats_5))
    # ----------------------------------
    feats_4 = conv2d(
          filters=num_filters,
          strides=1,
          ...
          name=f'semantic_4_0')(
              feats['4'])
    feats_4 = activation_fn(tf.keras.layers.GroupNormalization(256)(feats_4))
    feats_4 = spatial_transform_ops.nearest_upsampling(
          feats_4, 4, use_keras_layer=use_keras_layer)
    feats_4 = conv2d(
          filters=128,
          strides=1,
          kernel_size=3,
          ...
          name=f'semantic_4_1')(
              feats_4)
    feats_4 = activation_fn(tf.keras.layers.GroupNormalization(128)(feats_4))
    # ----------------------------------
    feats_3 = conv2d(
          filters=128,
          strides=1,
          ...
          name=f'semantic_3_0')(
              feats['3'])
    feats_3 = activation_fn(tf.keras.layers.GroupNormalization(128)(feats_3))
    feats_3 = spatial_transform_ops.nearest_upsampling(
          feats_3, 2, use_keras_layer=use_keras_layer)
    # ----------------------------------
    feats_2 = conv2d(
          filters=128,
          strides=1,
          ...
          name=f'semantic_2_0')(
              feats['2'])
    feats_2 = activation_fn(tf.keras.layers.GroupNormalization(128)(feats_2))
    feat = feats_2 + feats_3 + feats_4 + feats_5
    output = conv2d(
          filters=8,
          strides=1,
          kernel_size=7,
    ...
    output = spatial_transform_ops.nearest_upsampling(
          output, 4, use_keras_layer=use_keras_layer)
    output = conv2d(
          filters=1,
          strides=1,
          kernel_size=1,
    ...
    super(FPN, self).__init__(inputs=inputs, outputs=output, **kwargs)
