...
class MosaicSegmentationModel(keras.Model):
  ...
  def __init__(self,
               ...
               neck: Optional[keras.layers.Layer] = None,
               mask_scoring_head: Optional[keras.layers.Layer] = None,
               **kwargs):
  ...
  def checkpoint_items(
      self) -> Dict[str, Union[keras.Model, keras.layers.Layer]]:
