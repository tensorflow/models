...
class BasicBlock3DVolume(keras.layers.Layer):
...
@keras.utils.register_keras_serializable(package='Vision')
class ResidualBlock3DVolume(keras.layers.Layer):
  """A residual 3d block."""
  ...
  def build(self, input_shape):
    if self._use_projection:
      self._shortcut = keras.layers.Conv3D(
          filters=self._filters,
          kernel_size=1,
          strides=self._strides,
          use_bias=False,
    ...
    self._conv1 = keras.layers.Conv3D(
        filters=self._filters,
        kernel_size=3,
        strides=self._strides,
        padding='same',
    ...
    self._conv2 = keras.layers.Conv3D(
        filters=self._filters,
        kernel_size=3,
        strides=1,
        padding='same',
...
@keras.utils.register_keras_serializable(package='Vision')
class BottleneckBlock3DVolume(keras.layers.Layer):
  ...
  def build(self, input_shape):
    ...
    self._conv3 = keras.layers.Conv3D(
        filters=self._filters * 4,
        kernel_size=1,
        strides=1,
        use_bias=False,
