...
class DiceScore:
  ...
  This class follows the same function interface as keras.metrics.Metric but
  does not derive from keras.metrics.Metric or utilize its functions. The
  reason is a keras.metrics.Metric object does not run well on CPU while
