...
# Train the model for 100000 steps and evaluate every 5000 steps.
# Each train step, takes 4096 tokens as a batch budget.
...
2. ### Model training and evaluation
   ...
   [transformer_main.py](transformer_main.py) creates a Transformer keras model, and trains it uses keras model.fit().
