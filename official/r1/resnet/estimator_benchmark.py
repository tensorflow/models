...
class Resnet50EstimatorAccuracy(EstimatorBenchmark):
    ...
    """
        ...
        super(Resnet50EstimatorAccuracy,
...
class Resnet50EstimatorBenchmarkBase(EstimatorBenchmark):
    ...
    def __init__(self, output_dir=None, default_flags=None):
        ...
        super(Resnet50EstimatorBenchmarkBase,
...
class Resnet50EstimatorBenchmark(Resnet50EstimatorBenchmarkBase):
    ...
    def __init__(self, output_dir=None, default_flags=None):
        super(Resnet50EstimatorBenchmark,
    ...
    def benchmark_graph_fp16_1_gpu_tweaked(self):
        ...
        FLAGS.model_dir = self._get_model_dir(
            'benchmark_graph_fp16_1_gpu_tweaked')
...
class Resnet50EstimatorBenchmarkSynth(Resnet50EstimatorBenchmark):
    ...
    def __init__(self, output_dir=None, root_data_dir=None, **kwargs):
        ...
        super(Resnet50EstimatorBenchmarkSynth,
...
class Resnet50EstimatorBenchmarkReal(Resnet50EstimatorBenchmark):
    ...
    def __init__(self, output_dir=None, root_data_dir=None, **kwargs):
        def_flags = {}
        def_flags['data_dir'] = os.path.join(root_data_dir,
                                             IMAGENET_DATA_DIR_NAME)
        def_flags['max_train_steps'] = 110
        def_flags['train_epochs'] = 1

        super(Resnet50EstimatorBenchmarkReal,
              self).__init__(output_dir=output_dir, default_flags=def_flags)
...
class Resnet50MultiWorkerEstimatorBenchmark(Resnet50EstimatorBenchmarkBase):
    ...
    def __init__(self, output_dir=None, default_flags=None):
        super(Resnet50MultiWorkerEstimatorBenchmark,
              self).__init__(output_dir=output_dir, default_flags=default_flags)
...
class Resnet50MultiWorkerEstimatorBenchmarkSynth(
    ...
    def __init__(self, output_dir=None, root_data_dir=None, **kwargs):
        ...
        super(Resnet50MultiWorkerEstimatorBenchmarkSynth,
              self).__init__(output_dir=output_dir, default_flags=def_flags)
...
class Resnet56EstimatorAccuracy(EstimatorBenchmark):
    ...
    """
        ...
        super(Resnet56EstimatorAccuracy,
              self).__init__(output_dir=output_dir, flag_methods=flag_methods)
