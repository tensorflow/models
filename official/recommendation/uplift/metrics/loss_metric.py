...
class LossMetric(keras.metrics.Metric):
  ...
  >>> sliced_loss = LossMetric(keras.losses.mean_squared_error)
  ...
  ...     metrics=[LossMetric(keras.losses.mean_squared_error)]
  ... )
  """
  ...
  def __init__(
    ...
    self._treatment_sliced_loss = treatment_sliced_metric.TreatmentSlicedMetric(
        keras.metrics.Mean(name=name, dtype=dtype)
    )
  ...
  def get_config(self) -> dict[str, Any]:
    ...
    config["loss_fn"] = keras.utils.serialize_keras_object(self._loss_fn)
  ...
  def from_config(cls, config: dict[str, Any]) -> LossMetric:
    config["loss_fn"] = keras.utils.deserialize_keras_object(
        config["loss_fn"]
    )
