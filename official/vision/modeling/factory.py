...
def build_classification_model(
    ...
    backbone: Optional[keras.Model] = None) -> keras.Model:
...
def build_maskrcnn(input_specs: keras.layers.InputSpec,
                   ...
                   l2_regularizer: Optional[
                       keras.regularizers.Regularizer] = None,
                   backbone: Optional[keras.Model] = None,
                   decoder: Optional[keras.Model] = None) -> keras.Model:
  ...
  if not backbone:
    backbone = backbones.factory.build_backbone(
        ...
        norm_activation_config=norm_activation_config,
        l2_regularizer=l2_regularizer)
  backbone_features = backbone(keras.Input(input_specs.shape[1:]))
