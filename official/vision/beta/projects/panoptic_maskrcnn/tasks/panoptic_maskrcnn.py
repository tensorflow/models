...
class PanopticMaskRCNNTask(maskrcnn.MaskRCNNTask):
  ...
  def build_inputs(self,
    ...
    parser = panoptic_maskrcnn_input.Parser(
        ...
        resize_eval_segmentation_groundtruth=params.parser
  ...
  def train_step(self,
    ...
    if self.task_config.segmentation_evaluation.report_train_mean_iou:
      ...
      logs.update({self.segmentation_train_mean_iou.name:\
  ...
  def reduce_aggregated_logs(self, aggregated_logs, global_step=None):
    result = {}
    result[self.coco_metric.name] = \
      super(PanopticMaskRCNNTask, self).reduce_aggregated_logs(
