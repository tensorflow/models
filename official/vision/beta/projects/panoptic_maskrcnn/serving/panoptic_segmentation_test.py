...
class PanopticSegmentationExportTest(tf.test.TestCase, parameterized.TestCase):
  ...
  @parameterized.parameters(
      ('image_tensor', 'panoptic_maskrcnn_resnetfpn_coco', [384, 384]),
      ('image_bytes', 'panoptic_maskrcnn_resnetfpn_coco', [640, 640]),
      ('tf_example', 'panoptic_maskrcnn_resnetfpn_coco', [640, 640]),
  )
