...
class ExampleModel(keras.Model):
  ...
  A model is a subclass of keras.Model where layers are built in the
  constructor.
  """
  ...
  def __init__(
    ...
    Args:
      ...
      input_specs: A `keras.layers.InputSpec` spec of the input tensor.
    ...
    outputs = keras.layers.Dense(num_classes)(outputs)
...
def build_example_model(input_specs: keras.layers.InputSpec,
