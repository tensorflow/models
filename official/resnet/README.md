...
```
python cifar_download_and_extract.py --data_dir cifar10_data --dataset cifar10
python cifar_download_and_extract.py --data_dir cifar100_data --dataset cifar100
```

Then to train the model, run the following:

```
python cifar_main.py --data_dir cifar10_data --model_dir cifar10_model --dataset cifar10
python cifar_main.py --data_dir cifar100_data --model_dir cifar100_model --dataset cifar100
```
