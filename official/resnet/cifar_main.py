...
# ==============================================================================
"""Runs a ResNet model on the CIFAR-10 or CIFAR-100 dataset."""
...
# Running the model
###############################################################################
class CifarModel(resnet_model.Model):
  """Model class with appropriate defaults for CIFAR data."""

  def __init__(self, resnet_size, data_format=None, num_classes=_NUM_CLASSES,
               resnet_version=resnet_model.DEFAULT_VERSION,
               dtype=resnet_model.DEFAULT_DTYPE):
    """These are the parameters that work for CIFAR data.
...
def cifar_model_fn(features, labels, mode, params):
  ...
  # for the CIFAR dataset, perhaps because the regularization prevents
...
def define_cifar_flags():
  ...
  flags_core.set_defaults(data_dir='/tmp/cifar_data',
                          model_dir='/tmp/cifar_model',
                          resnet_size='50',
                          train_epochs=250,
...
def run_cifar(flags_obj):
  """Run ResNet CIFAR training and eval loop.

  Args:
    flags_obj: An object containing parsed flag values.
  """
  global DATASET_NAME, _NUM_CLASSES, _RECORD_BYTES, _NUM_DATA_FILES
  if flags_obj.dataset == "cifar10":
    DATASET_NAME = "cifar10"
    _RECORD_BYTES = _DEFAULT_IMAGE_BYTES + 1
    _NUM_DATA_FILES = 5
    _NUM_CLASSES = 10
  ...
  resnet_run_loop.resnet_main(
      flags_obj, cifar_model_fn, input_function, DATASET_NAME,
